...
if("TRUE" STREQUAL "TRUE")
  set(laser_filters_SOURCE_PREFIX /home/dongheehan/ROS-and-Gazobe/src/laser_filters)
  set(laser_filters_DEVEL_PREFIX /home/dongheehan/ROS-and-Gazobe/devel)
  ...
  set(laser_filters_INSTALL_PREFIX /home/dongheehan/ROS-and-Gazobe/install)
...
if(NOT "/home/dongheehan/ROS-and-Gazobe/src/laser_filters/include " STREQUAL " ")
  set(laser_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/dongheehan/ROS-and-Gazobe/src/laser_filters/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jon Binney <jon.binney@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dongheehan/ROS-and-Gazobe/src/laser_filters/${idir}'.  Ask the maintainer 'Jon Binney <jon.binney@gmail.com>' to fix it.")
    endif()
