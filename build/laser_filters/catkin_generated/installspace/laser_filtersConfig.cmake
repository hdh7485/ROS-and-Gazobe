...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dongheehan/ROS-and-Gazobe/install/${idir}'.  Ask the maintainer 'Jon Binney <jon.binney@gmail.com>' to fix it.")
    endif()
